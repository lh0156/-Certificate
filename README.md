    ...
    - 개발 기술 환경 정의
        - 개발 기술 환경 현행 시스템 분석
            ...
            - 미들웨어 현행 시스템 분석
                ...
                - WAS의 개념
                    - 서버계층에서 애플리케이션이 동작할 수 있는 환경을 제공하고 안정적인 트랜잭션 처리와 관리, 다른 이기종 시스템과의 애플리케이션 연동을 지원하는 서버이다.
                - 미들웨어 현행 시스템 분석
            - 오픈 소스 사용 시 고려 사항
        - 개발 기술 환경 요구사항 파악
            - 기술 환경 정의를 위한 자료 수집
                - 수집 자료 목록 및 조사 항목을 설정한다
                    - 시스템 구축 형태, 사용자 수, **트랜잭션 수**
                ...
                - 도분명확
                    - 도출
                        ...
                        - 주요 기법
                            ...
                            - 설문조사
                    - 분석
                        - 충돌, 중복, 누락 등의 분석을 통해 완전성과 일관성 확보
                        - 분석 절차
                            - 분개할협정
                                - 요구사항 분류
                                - 개념 모델링 생셩 및 분석
...
- **공통 모듈 구현**
    ...
    - **소프트웨어 모듈 응집도**
        ...
        - **응집도의 유형**
            - **우논시절통순기**
                ...
                - 논리적 응집도
                    - 유한 성격을 갖거나 특정 형태로 분류되는 처리 요소들이 한 모듈에서 처리되는 경우의 응집도
                - 시간적 응집도
    ...
    - **소프트웨어 모듈 결합도**
        - 내공외제스자
            - 내용 결합도
                - 다른 모듈 내부에 있는 변수나 기능을 다른 모듈에서 사용하느 ㄴ경우의 결합도
            - 공통 결합도
            ...
            - 제어 결합도
                - 어떤 모듈이 다른 모듈의 내부 조직을 제어하기 위한 목적으로 제어 신호를 이용하여 통신하는 경우의 결합도
            - 스탬프 결합도
...
- **소프트웨어 개발 보안 설계**
    - SW 개발 보안의 개념
        - 소스코드 등에 존재하은 보안 취약점을 제거하고, 보안을 고려하여 기능을 설계 및 구현하는 등 소프트웨어 개발 과정에서 지켜야 할 일련의 보안 활동
    - **SW 개발 보안 생명주기**
        - **요설구테유**
            - 요구사항 명세
            - 설계
    ...
    - **SW 개발 보안의 구성 요소**
        - **SW 개발 보안의 3대 요소**
            - **기무가**
                ...
                - 무결성
                    ...
                    정당한 방법을 따르지 않고서는 데이터가 변셩될 수 없으며, 데이터의 정확성 및 완전성과 고의/악의로 변경되거나 훼손 또느 파괴되지 않음을 보장하는 특성
        ...
        - **SW 개발 보안 용어**
            - **자위취위**
                ...
                - 위협
                    - 조직이나 기업의 자산에 악영향을 끼칠 수 있는 사건이나 행위 → 해킹, 삭제, 자산의 불법적인 유출
                - 취약점
                    - 위협이 발생하기 위한 사전 조건으로 시스템의 정보 보증을 낮추는 데 사용되는 약점
                    → 평문 전송, 입력값 미검증, 비밀번호 공유
                - 위험
                    - 위협이 취약점을 이요하여 조직의 자산 손실 피해를 가져올 가능성
    - **SW 개발 보안을 위한 공격기법의 이해**
        - **Dos 공격**
            ...
            - Dos 공격의 종류
                ...
                - **Ping of Death**
                    - ICMP 패킷을 정상적인 크기보다 아주 크게 만들어 전송하면 다수의 IP 단편화가 발생하고, 수신 측에서는 단편화된 패킷을 처리(재조합)하는 과정에서 많은 부하가 발생하거나 재조합 버퍼의 오버플로우가 발생하여 정상적인 서비스를 하지 못하도록 하는 기법
                - **랜드 어택**
                    - 출발지와 목적지를 같은 IP 패킷 주소로 만들어 보냄으로써 수신자가 자기 자신에게 응답을 보내게 하여 시스템의 가용성을 침해하는 공격 기법
                - **티어 드롭**
                - **봉크 / 보잉크**
        - **DDoS 공격**
            - DDos 공격의 개념
